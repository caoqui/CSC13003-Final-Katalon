...
WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.14/a_Demo'))

WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.14/button_Sign in'))

WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.14/span_demofirefly_fa fa-plus-circle'))
...
WebUI.verifyEqual(actual_notes, expected_notes)
