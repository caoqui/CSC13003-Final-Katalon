...
WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.12/a_Demo'))

WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.12/button_Sign in'))

WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.12/span_demofirefly_fa fa-plus-circle'))
...
WebUI.verifyEqual(actual_account_number, expected_account_number)
