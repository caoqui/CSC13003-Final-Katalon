...
WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.13/a_Demo'))

WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.13/button_Sign in'))

WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.13/span_demofirefly_fa fa-plus-circle'))
