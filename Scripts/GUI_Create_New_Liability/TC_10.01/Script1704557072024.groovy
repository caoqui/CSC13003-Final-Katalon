...
WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.01/a_Demo'))

WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.01/button_Sign in'))
