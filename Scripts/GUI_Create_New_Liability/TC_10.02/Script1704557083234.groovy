...
WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.02/a_Demo'))

WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.02/button_Sign in'))

WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.02/span_demofirefly_fa fa-plus-circle'))
