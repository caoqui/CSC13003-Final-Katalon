...
WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.08/a_Demo'))

WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.08/button_Sign in'))

WebUI.click(findTestObject('Object Repository/GUI_Create_New_Liability/TC_10.08/span_demofirefly_fa fa-plus-circle'))
...
WebUI.verifyEqual(actual_interest, expect_interest)
