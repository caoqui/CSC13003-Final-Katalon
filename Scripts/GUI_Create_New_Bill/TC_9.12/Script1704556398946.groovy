...
WebUI.click(findTestObject('Object Repository/GUI_Create_New_Bill/TC_9.12/a_Demo'))

WebUI.click(findTestObject('Object Repository/GUI_Create_New_Bill/TC_9.12/button_Sign in'))

WebUI.click(findTestObject('Object Repository/GUI_Create_New_Bill/TC_9.12/span_demofirefly_fa fa-plus-circle'))
